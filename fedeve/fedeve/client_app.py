"""ClientApp FedEve : entrainement local STANDARD (comme FedAvg).

Toute la specificite FedEve est cote SERVEUR (filtre de Kalman dans
`FedEveStrategy`). Le client ne calcule rien de special : il prend w_t,
fait E epochs de SGD local, et renvoie w_local. Le serveur compare avec
w_t pour calculer Delta_k = w_t - w_local_k, puis fusionne via Kalman.
"""
...
def train(msg: Message, context: Context):
    ...
    # entrainement SGD standard (le filtre de Kalman est cote serveur)
