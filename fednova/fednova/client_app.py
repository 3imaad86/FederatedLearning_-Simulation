...
def train(msg: Message, context: Context):
    ...
    # La formule tau_eff suppose vanilla SGD (momentum=0).
    if c["momentum"] != 0.0:
        raise ValueError(
            f"FedNova exige momentum=0.0 (theorie Wang 2020 Option C basee "
            f"sur vanilla SGD). Recu momentum={c['momentum']} cote client. "
    ...
    # entrainement SGD standard (le rescaling FedNova est fait cote serveur)
    ...
    # tau_i = nombre de pas SGD locaux (num_steps retourne par train_fn).
